...
class ModelTrainer:
    ...
    def train(self):
        ...
        trainer_args=TrainingArguments(
            ...
            per_device_train_batch_size=self.config.per_device_train_batch_size, weight_decay=self.config.weight_decay,
            logging_steps=self.config.logging_steps ,eval_strategy=self.config.evaluation_strategy,
